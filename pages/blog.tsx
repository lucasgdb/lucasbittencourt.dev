    ...
    >
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          Este blog tem o intuito de ajudar pessoas iniciantes tanto quanto
          melhorar meus conhecimentos, buscando informações e aprendendo com
          isso. Ao total, há {posts.length} artigo
